...
class Day16 : AOCSolution {
    ...
    override fun solve(): AOCAnswer {
        ...
        val (topSide, bottomSide) = with(rows) { map { Beam(it at -1, right) } to map { Beam(it at (last + 1), left) } }
    ...
    private fun getNextBeams(beam: Beam, matrix: List<List<Char>>): List<Beam> {
